...
namespace KNotifications
{
    ...
    class DataTypes
    {
        ...
        public static int Title() { return getId("title"); }

        /// <summary>
        /// Get Content Id
        /// </summary>
        /// <returns>(int) Content Id</returns>
        public static int Content() { return getId("content"); }

        /// <summary>
        /// Get Opacity Id
        /// </summary>
        /// <returns>(int) Opacity Id</returns>
        public static int Opacity() { return getId("opacity"); }

        /// <summary>
        /// Get BackgroundColor Id
        /// </summary>
        /// <returns>(int) BackgroundColor Id</returns>
        public static int BackgroundColor() { return getId("backgroundColor"); }

        /// <summary>
        /// Get FontColor Id
        /// </summary>
        /// <returns>(int) FontColor Id</returns>
        public static int FontColor() { return getId("fontColor"); }

        /// <summary>
        /// Get Time Id
        /// </summary>
        /// <returns>(int) Time Id</returns>
        public static int Time() { return getId("time"); }
        ...
        {
            return Convert.ToInt32(data.FirstOrDefault(x => x.Value == temp));
        }
    }
}
